...
namespace EBS.Infrastructure.Helper
{
   public class BarCodeHelper
    {/// <summary>
     /// 生成条码
     /// </summary>
     /// <param name="sourceCode">条码内容</param>
     /// <returns>条码Bitmap</returns>
...
                 /* * */ "010010100"
        ...
        private void GetViewText(Bitmap p_Bitmap, string p_ViewText)
        {
            ...
            int _StarX = (p_Bitmap.Width - (int)_DrawSize.Width) / 2;
            ...
            _Graphics.DrawString(p_ViewText, m_ValueFont, Brushes.Black, _StarX, _StarY);
        }
    }
}
